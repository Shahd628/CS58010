...
supported_fl_algorithm = ["isolate", "fedala","fedalaghn", "fedalare" "fedavg", "fedprox", "scaffold", "moon", "feddc", "fedproto", "fedtgp", "fedpub", "fedstar", "fedgta", "fedtad", "gcfl_plus", "fedsage_plus", "adafgl", "feddep", "fggp", "fgssl", "fedgl"]
...
# AGHN+FedALA
parser.add_argument("--use_aghn_alpha", type=bool, default=False, help="Toggle on and off whther to incorporate graph hypernetworks or not into FedALA")
parser.add_argument("--aghn_alpha_mode", type=str, default='init', help="Either initilize coefficients alpha with the hypernetwork and use that for aggregation, or allow for fixed alpha values")
parser.add_argument("--aghn_warmup_rounds", type=int, default=10, help="Number of initial training rounds during which ????")
parser.add_argument("--beta_hn", type=float, default=1.0, help="Tunable hypernetwork hyperparameter")
parser.add_argument("--gama_hn", type=float, default=0.5, help="Tunable hypernetwork hyperparameter")
...
parser.add_argument("--wandb_project", type=str, default="openfgl")
parser.add_argument("--wandb_entity", type=str, default=None)
parser.add_argument("--wandb_name", type=str, default=None)
parser.add_argument("--wandb_group", type=str, default=None)
parser.add_argument("--wandb_id", type=str, default=None)
parser.add_argument("--wandb_tags", type=str, default=None)  # comma-separated, optional
